...
<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage: `url(${info.bgImg})`}">
      <a class="back" @click="$router.back()"> <!-- 返回按钮 -->
...
<!-- 商家相关的信息 -->
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportShow">
        <div class="activity-sheet-content">  <!-- 遮罩层样式 -->
...
export default {
  data() {
    return {
      supportClasses: ["activity-green", "activity-red", "activity-orange"], //定义一个显示优惠活动的不同颜色的数组
      shopShow: false,
      supportShow: false
    };
  },
  computed: {
    ...mapState(["info"]) //获取商家的信息
  },
